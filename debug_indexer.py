...
for batch_successes, batch_bases, batch_indices, batch_errors in zip(
        solution_successes, solution_bases, solution_indices, solution_errors
):
    for success, basis, solution_mask, claimed_error in zip(
            batch_successes, batch_bases, batch_indices, batch_errors
    ):
        ...
        print(torch.sum(solution_mask).item(), "num spots in solution ")
